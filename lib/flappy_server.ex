defmodule FlappyServer do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: FlappyServer.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    FlappyServer.Endpoint.config_change(changed, removed)
    :ok
  end
end
